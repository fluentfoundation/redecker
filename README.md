...
> **Status:** early. Twelve rules and three commands work end to end, tested against real packages
...
| `RDK0012` | warning | A stable package that depends on a prerelease |
